import { Meta, Intro, Teaser } from '../../.storybook/components';
import { Image } from '../../packages/circuit-ui/components/Image/Image.js';
...
<Image
  ...
  srcDark="/images/logo-name-brand-dark.png"
...
[Browse icons](Icons/Overview/Docs)

</Teaser>

<Teaser title="Illustrations">

Explore available illustrations in the Circuit UI illustrations library.

[Browse illustrations](Features/Illustrations/Docs)
