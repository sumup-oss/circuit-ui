...
- **Do not** frame labels as questions (such as *"What is your phone
...
- **Do** write items in a positive manner. (e.g. *"Send me reports"* instead of *"Do not send me reports"*)
...
- **Do not** use negations (e.g. *“Don’t send me more email”*)
...
types of input are used when the expected text is more than one line.
