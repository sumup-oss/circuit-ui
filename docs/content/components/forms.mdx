...
<Playground>
  <AutoCompleteInput
    items={['apples', 'bananas', 'carrots', 'grapes', 'oranges', 'pears', 'strawberries']}
...
Autocomplete Tags allows picking from a selection of tags based on a given list of tags.

<Playground>
  <AutoCompleteTags
    availableTags={['apples', 'bananas', 'carrots', 'grapes', 'oranges', 'pears', 'strawberries']}
    onChange={e => { console.log('On change') }}
  />
</Playground>