...
## Button group
Used when our merchant has two opposites actions to be taken in a certain step of a flow. It has a primary
button for the expected action and a secondary button on its left 
