...
<Playground>
  <ButtonGroup align={ButtonGroup.CENTER}>
    {/* Take a look at the Storybook to see an implementation of LoadingButton */}
    <LoadingButton>Load</LoadingButton>
    <LoadingButton exitAnimation="SUCCESS">Load success</LoadingButton>
    <LoadingButton exitAnimation="ERROR">Load error</LoadingButton>
  </ButtonGroup>
</Playground>
