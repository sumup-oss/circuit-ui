...
Theming is built into [Emotion](https://github.com/emotion-js/emotion), our CSS-in-JS library. You need to make the theme available to the components by wrapping your application in a `ThemeProvider` (this is already configured when using [`create-sumup-react-app`](https://github.com/sumup-oss/circuit-ui/tree/main/packages/create-sumup-react-app)):
