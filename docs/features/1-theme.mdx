...
<ColorsTable customProperties={filterCustomProperties(schema, 'bg')} />

### Foreground colors

<ColorsTable customProperties={filterCustomProperties(schema, 'fg')} />

### Border colors

<ColorsTable customProperties={filterCustomProperties(schema, 'border')} />
