...
```
theme.typography.[headlines|subHeadlines|text].<SIZE_NAME>.[fontSize|lineHeight]
```
...
<Preview>
  <Type size="one" component={Headline} name="headings" />
  <Type size="two" component={Headline} name="headings" />
  <Type size="three" component={Headline} name="headings" />
  <Type size="four" component={Headline} name="headings" />
</Preview>

### Subheadline

<Preview>
  <Type component={SubHeadline} name="subHeadlines" />
</Preview>

### Body

<Preview>
  <Type size="one" component={Body} name="text" />
  <Type size="two" component={Body} name="text" />
</Preview>
