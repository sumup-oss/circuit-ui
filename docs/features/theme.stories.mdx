...
```
theme.typography.[headings|subHeadlines|text].<SIZE_NAME>.[fontSize|lineHeight]
```
...
<Preview>
  <Type size="zetta" component={Headline} name="headings" />
  <Type size="exa" component={Headline} name="headings" />
  <Type size="peta" component={Headline} name="headings" />
  <Type size="tera" component={Headline} name="headings" />
  <Type size="giga" component={Headline} name="headings" />
  <Type size="mega" component={Headline} name="headings" />
  <Type size="kilo" component={Headline} name="headings" />
</Preview>

### Subheadline

<Preview>
  <Type size="mega" component={SubHeadline} name="subHeadlines" />
  <Type size="kilo" component={SubHeadline} name="subHeadlines" />
</Preview>

### Body

<Preview>
  <Type size="giga" component={Body} name="text" />
  <Type size="mega" component={Body} name="text" />
  <Type size="kilo" component={Body} name="text" />
</Preview>
...
<Preview>
  <Type size="mega" bold component={Body} fontWeight="bold" name="text" />
  <Type size="mega" component={Body} fontWeight="regular" name="text" />
</Preview>
