...
import { Headline, SubHeadline, Text } from '../../packages/circuit-ui';
...
Avoid using `theme.typography` directly in your styles, rather use the specialized components [`Headline`](Typography/Headline/Base), [`SubHeadline`](Typography/SubHeadline/Base), and [`Text`](Typography/Text/Base).
