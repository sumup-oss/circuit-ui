...
The input component supports 2 different sizes:

- Inputs are medium-sized (`m`) by default. Medium is suitable for most use cases.
- The small size (`s`) is to better utilise limited space in certain contexts.
