import { Meta, Props } from '../../../../.storybook/components';
...
The SkipLink component is typically placed at the top of a page, before the main content. It is already included in the [TopNavigation](Navigation/TopNavigation/Docs) and [SideNavigation](Navigation/SideNavigation/Docs) components.
