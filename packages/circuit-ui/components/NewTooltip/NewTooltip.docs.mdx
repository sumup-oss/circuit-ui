...
<Story id="components-newtooltip--base" />
...
<Story id="components-newtooltip--top" />

<Story id="components-newtooltip--bottom" />

<Story id="components-newtooltip--left" />

<Story id="components-newtooltip--right" />
