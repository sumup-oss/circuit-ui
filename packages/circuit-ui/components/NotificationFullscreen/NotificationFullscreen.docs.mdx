...
<Story id="components-notificationfullscreen--base" />
<Props />
...
- Headline should be rendered on a page where there is an h1 to keep up a correct headline structure.
...
- The positioning of the buttons withing a button group follows the guidelines of the button group component.
