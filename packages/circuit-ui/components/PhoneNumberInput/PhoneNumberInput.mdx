...
Use `countryCode.variant="autocomplete"` to render a searchable country selector instead of a native select. This is useful when the list of countries is long.

<Story of={Stories.CountryCodeAutocomplete} />
