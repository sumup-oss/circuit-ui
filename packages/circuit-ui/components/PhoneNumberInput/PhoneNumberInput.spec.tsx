...
describe('PhoneNumberInput', () => {
  ...
  it('should meet accessibility guidelines with custom option labels', async () => {
    const { container } = render(
      <PhoneNumberInput
        {...defaultProps}
        countryCode={{
  ...
  it('should use getOptionLabel for autocomplete option labels', async () => {
  ...
  it('should use option.label for autocomplete option labels', async () => {
    render(
      <PhoneNumberInput
        {...defaultProps}
        countryCode={{
    ...
    expect(
      screen.getByRole('option', { name: 'Label DE' }),
    ).toBeInTheDocument();
  });
